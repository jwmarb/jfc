...
const MCP_REFRESH_REMINDER: &str = "An MCP server announced `tools/list_changed`. The tool \
...
const NARRATION_BYTES_FLOOR: usize = 40;

fn assistant_text_bytes_since_last_user(messages: &[ChatMessage]) -> usize {
