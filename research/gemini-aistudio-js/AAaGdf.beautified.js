...
(function(_) {
	...
	try {
		...
		_.Xr = class {
			constructor() {
				this.It = "video";
				this.Eq = "https://www.gstatic.com/aistudio-static/vibe_code/vibe-code-hero.mp4";
				this.Jt = "Turn your ideas into real apps with Gemini in Google AI Studio.";
				this.X0a = "https://aistudio.google.com/apps";
				this.W0a = "Build your first app";
				this.r$ = {
					label: "Get started",
					routerLink: "/apps",
					icon: "login"
				...
				this.Jna = [
					{
						label: "A conversational language learning app",
						icon: "auto_stories",
						url: "/apps",
						queryParams: { prompt: "Build a language learning app that provides a real-time conversational AI partner for practice." }
					},
					{
						label: "An app to remove backgrounds",
						icon: "center_focus_strong",
						url: "/apps",
						queryParams: { prompt: "Create an app to remove backgrounds and clean up product photos just by typing instructions" }
					},
					{
						label: "Help me design my dream garden",
						icon: "yard",
						url: "/apps",
						queryParams: {
				...
				this.blocks = [
					...
					},
					{
						...
						title: "Or remix an existing project",
						description: "Iterate on an existing creation, or your own, by incorporating straightforward feedback",
						video: "https://www.gstatic.com/aistudio-static/vibe_code/vibe_coding_mix.mp4"
					},
					{
						Vk: "svg-file",
						icon: "https://www.gstatic.com/aistudio-static/vibe_code/icon_rocket.svg",
						title: "Share with the world",
						description: "Launch your project to the entire world in a single click and give instant access to everyone, everywhere.",
						video: "https://www.gstatic.com/aistudio-static/vibe_code/vibe_coding_publish.mp4"
					}
				];
				this.Cza = [
					{
						question: "What is “Vibe Coding”?",
						answer: "Vibe coding is a new way to build apps using only your words instead of complex code. You simply describe the \"vibe\" or goal of your project—like a personal budget tracker or a travel planner—and Gemini handles the heavy lifting. It automatically writes the instructions, builds the visual interface, and sets up the logic behind the scenes. It's designed to turn your ideas into functional software instantly, making app creation as easy as having a conversation with a helpful assistant."
					},
					{
						question: "How do I share my app with friends?",
						answer: "To gather feedback or share your app with a group of coworkers or friends, you can use the share feature. This is an optional step before launching your app that lets you send a link to your app in AI Studio around for testing and experimentation. Click Share, add individual emails or adjust sharing settings then copy the link to send."
					},
					{
						question: "How do I launch my app?",
						answer: "Once you're happy with how your app looks and works in the preview, you can publish it to the world in one click. Simply hit the Deploy button to host it directly on Google Cloud Run, or use the Save to GitHub option to create a permanent home for your project. This gives you a live link that you can post online or send to customers immediately, moving your project from a private draft to a real, working website."
					},
					{
						question: "Do I need to know how to code to use this?",
						answer: "Not at all! AI Studio is built for everyone, regardless of technical background. You don't need to study programming languages or memorize syntax to get started. The system is \"zero-friction,\" meaning you can go from an empty page to a finished app just by typing in plain English. While experts can still dive into the code if they want to, beginners can successfully build and launch entire projects without ever writing a single line of traditional code."
					},
					{
						question: "How do I make changes to an app?",
						answer: "Editing your app is as simple as asking for what you want. If you want to change a color, add a new feature, or fix a mistake, just type a message like \"make the header blue\" or \"add a search bar at the top\". The AI will instantly rewrite the necessary parts and update the Live Preview right in front of you. This allows you to experiment freely and see your changes happen in real-time until the app feels just right."
					},
					{
						question: "Is Google AI Studio free to use?",
						answer: "Yes, Google AI Studio is a free tool for anyone who wants to experiment, prototype, and build. You can access the latest models and the app-building features without a monthly subscription fee. While there are paid tiers for professional developers who need to handle massive amounts of traffic, the standard \"playground\" experience is designed to be accessible to everyone at no cost, allowing you to learn and create without financial barriers."
					},
					{
						question: "Is my data private?",
						answer: "Your privacy is a top priority. When you use AI Studio, your prompts and the apps you build are protected by Google's enterprise-grade security. Importantly, your data is not used to train or improve models for other people without your permission. You have full control over your projects, your saved files, and your API keys, ensuring that your creative ideas and personal information remain yours and yours alone."
					}
				];
			}
		};
		...
		_.Xr.ka = _.u({
			type: _.Xr,
			da: [["ms-marketing-vibe-code-screen"]],
			eb: [
				1,
				"marketing-v2-theme",
				"dark-theme"
			...
			template: function(a, b) {
				a & 1 && _.I(0, "ms-marketing-nav", 0)(1, "ms-marketing-hero", 1)(2, "ms-marketing-blocks", 2)(3, "ms-marketing-remix", 3)(4, "ms-marketing-prompt-builder", 4)(5, "ms-marketing-faq", 5)(6, "ms-marketing-footer");
				a & 2 && (_.E("cta", b.r$), _.y(), _.E("mediaType", b.It)("mediaSrc", b.Eq)("subtitle", b.Jt)("ctaUrl", b.X0a)("ctaText", b.W0a), _.y(), _.E("blocks", b.blocks), _.y(), _.E("filters", b.ZHa)("cards", b.pC), _.y(), _.E("suggestions", b.Jna), _.y(), _.E("items", b.Cza));
			},
			dependencies: [
				_.i8,
				_.u8,
