...
(function(_) {
	...
	try {
		...
		var zMd = function(a) {
			if (a & 1) {
				_.F(0, "div", 14), _.z(1, yMd, 1, 0, "ng-container", 23), _.H();
			}
			if (a & 2) {
				_.K(2), a = _.O(3), _.y(), _.E("ngTemplateOutlet", a);
			}
		};
		var AMd = function(a) {
			if (a & 1) {
				_.F(0, "span", 13), _.Mh(1, 5), _.H();
			}
		};
		var DMd = function(a, b) {
			if (a & 1) {
				_.F(0, "a", 21), _.R(1), _.H();
			}
			if (a & 2) {
				a = b.V, b = _.K(2), _.E("routerLink", _.Ai(5, BMd, b.Zv.Nea))("queryParams", _.Ai(7, CMd, a.Ya()))("routerLinkActive", b.Ye.class)("routerLinkActiveOptions", b.Ye.options), _.y(), _.S(" ", a.getDisplayName() || a.Ya(), " ");
			}
		};
		var EMd = function(a) {
			if (a & 1) {
				_.Gh(0), _.Mh(1, 6), _.Hh();
			}
		};
		var FMd = function(a) {
			if (a & 1) {
				_.Gh(0), _.Mh(1, 7), _.Hh();
			}
		};
		var GMd = function(a) {
			if (a & 1) {
				...
				_.J("click", function() {
					_.q(b);
					var c = _.K(2);
					return _.t(c.Mba.set(!c.Mba()));
				});
				_.B(1, EMd, 2, 0, "ng-container")(2, FMd, 2, 0, "ng-container");
				_.H();
			}
			if (a & 2) {
				a = _.K(2), _.y(), _.C(a.Mba() ? 1 : 2);
			}
		};
		var IMd = function(a) {
			if (a & 1) {
				let b = _.n();
				_.F(0, "mat-expansion-panel", null, 1)(2, "mat-expansion-panel-header", 12)(3, "mat-panel-title", 13);
				_.B(4, zMd, 2, 1, "div", 14)(5, AMd, 2, 0, "span", 13);
				_.H()();
				_.F(6, "div", 15)(7, "div", 16)(8, "span", 17);
				_.Kh(9, 3);
				_.I(10, "span", 18)(11, "span", 19);
				_.Lh();
				_.H();
				_.F(12, "button", 20);
				_.J("click", function() {
					_.q(b);
					var c = _.K();
					return _.t(c.CB.emit());
				});
				_.Mh(13, 4);
				_.H()();
				_.F(14, "div", 14);
				_.Ah(15, DMd, 2, 9, "a", 21, HMd);
				_.H();
				_.B(17, GMd, 3, 1, "button", 22);
				_.H()();
			}
			if (a & 2) {
				a = _.O(1);
		...
		var KMd = function(a) {
			if (a & 1) {
				_.Gh(0), _.Mh(1, 8), _.Hh();
			}
		};
		var LMd = function(a) {
			if (a & 1) {
				_.Gh(0), _.Mh(1, 9), _.Hh();
			}
		};
		var MMd = function(a) {
			if (a & 1) {
				let b = _.n();
				_.F(0, "div", 26)(1, "button", 27);
				_.J("click", function() {
					_.q(b);
					var c = _.K(2);
					return _.t(c.bo());
				});
				_.B(2, KMd, 2, 0, "ng-container")(3, LMd, 2, 0, "ng-container");
				_.H()();
			}
			if (a & 2) {
				a = _.K(2), _.y(), _.P("expanded", a.vc()), _.y(), _.C(a.vc() ? 2 : 3);
			}
		};
		var NMd = function(a) {
			if (a & 1) {
				_.F(0, "div", 25)(1, "div", 14, 2), _.z(3, JMd, 1, 0, "ng-container", 23), _.H(), _.B(4, MMd, 4, 3, "div", 26), _.H();
			}
			if (a & 2) {
				a = _.K();
				let b = _.O(3);
		...
		var QMd = function(a, b) {
			if (a & 1) {
				_.F(0, "span", 29)(1, "a", 30), _.R(2), _.H(), _.B(3, PMd, 1, 0), _.H();
			}
			if (a & 2) {
				a = b.V;
				let c = b.jb;
				...
				let d = _.K(2);
				_.y();
				_.E("routerLink", _.Ai(6, BMd, d.Zv.Nea))("queryParams", _.Ai(8, CMd, a.Ya()))("routerLinkActive", d.Ye.class)("routerLinkActiveOptions", d.Ye.options);
				_.y();
				_.S(" ", a.getDisplayName() || a.Ya());
				_.y();
				_.C(c !== b - 1 ? 3 : -1);
			}
		};
		var RMd = function(a) {
			if (a & 1) {
				_.F(0, "span", 28), _.Mh(1, 10), _.H(), _.B(2, OMd, 1, 0), _.Ah(3, QMd, 4, 10, "span", 29, HMd);
			}
			if (a & 2) {
				a = _.K(), _.y(), _.Qh(a.ik().length)(a.ik().length), _.Rh(1), _.y(), _.C(a.ik().length > 0 ? 2 : -1), _.y(), _.Bh(a.ik());
			}
		};
		_.GG.prototype.Pqa = _.ca(175, function(a) {
			var b = this;
			return _.x(function* () {
				var c = new _.Qbb();
				c = _.Uc(c, 1, a);
				var d = b.I;
				yield _.$q(d.A, d.F + "/$rpc/google.internal.alkali.applications.makersuite.v1.MakerSuiteService/UpgradeAndDisablePrepay", c, {}, _.Sbb);
				yield _.FG(b, { fR: true });
			});
		});
		var wNd = function(a) {
			return _.x(function* () {
				a.R.set(0);
				var b;
				var c = (b = a.Rp()) == null ? undefined : b.getName();
				if (c) {
					b = new _.e8a();
					c = _.Uc(b, 1, c);
					try {
						var d = a.I;
						let e = yield _.$q(d.A, d.F + "/$rpc/google.internal.alkali.applications.makersuite.v1.MakerSuiteService/GetPrepayEligibility", c, {}, _.g8a);
						a.R.set(_.Lm(e, 1));
					} catch (e) {
						throw e;
					}
		...
		var BMd = (a) => ["/", a];
		var CMd = (a) => ({ project: a });
		var HMd = (a, b) => b.getName();
		var ANd = class {
			constructor() {
				this.Za = _.m(_.Iy);
				this.Pa = _.m(_.Xf);
				this.A = _.m(_.Op);
				this.eCb = this.A.getFlag(_.YFb);
				this.Ye = _.E3;
				this.Zv = _.Wy;
				this.vo = _.Li.required();
				this.CB = _.Ki();
				this.vc = _.M(false);
				this.Z$a = _.M(false);
				this.T6 = _.Ni(_.KE);
				this.Mba = _.M(false);
				this.L7a = _.Ni("projectsList");
				this.ik = _.W(() => {
					var a = this.vo();
					return a ? xMd(this.Za.Sd(), a) : [];
				});
				this.dB = _.W(() => {
					var a = this.ik();
					return this.Mba() ? a : a.slice(0, 6);
				});
				this.jFb = _.W(() => this.ik().length > 6);
				_.Fk([this.ik], () => {
					_.bg({ read: () => {
						var a;
						var b = (a = this.L7a()) == null ? undefined : a.nativeElement;
						if (b) {
							this.Z$a.set(b.scrollWidth > b.clientWidth);
						}
					} }, { Pa: this.Pa });
				});
				_.Fk([this.vo], () => {
		...
		ANd.ka = _.u({
			type: ANd,
			da: [["ms-billing-projects"]],
			Ka: function(a, b) {
				if (a & 1) {
					_.ji(b.T6, _.KE, 5)(b.L7a, zNd, 5);
				}
				if (a & 2) {
					_.ki(2);
				}
			},
			inputs: { vo: [1, "billingAccountName"] },
			outputs: { CB: "importProjects" },
			ha: 4,
			ia: 1,
			la: () => {
				var a = _.Sh("{VAR_PLURAL, plural, =0 {0 projects} =1 {1 project} other {{INTERPOLATION} projects}}", {
					INTERPOLATION: "�1�",
					VAR_PLURAL: "�0�"
				});
				a = _.Sh("�#10�Imported in AI Studio[�/#10�|�/#11�]�#11� · " + a + " [�/#10�|�/#11�]");
				var b = _.Sh("{VAR_PLURAL, plural, =0 {0 Projects} =1 {1 Project} other {{INTERPOLATION} Projects}}", {
					INTERPOLATION: "�1�",
					VAR_PLURAL: "�0�"
				});
				return [
					...
					[
						"data-test-id",
						"billing-projects-info",
						1,
						"projects-info",
						3,
						"expanded"
					],
					[1, "custom-expand-icon"],
					[1, "title"],
					[1, "projects-list"],
					[1, "content"],
					[1, "subheader"],
			...
			template: function(a, b) {
				if (a & 1) {
					_.B(0, IMd, 18, 4, "mat-expansion-panel")(1, NMd, 5, 6, "div", 11), _.z(2, RMd, 5, 3, "ng-template", null, 0, _.Ii);
				}
				if (a & 2) {
					_.C(b.eCb ? 0 : 1);
				}
			...
			styles: ["[_nghost-%COMP%]{min-width:0}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]{--mat-expansion-header-collapsed-state-height:53px;--mat-expansion-header-expanded-state-height:53px;--mat-expansion-container-shape:12px;background-color:var(--color-v3-surface-container);box-shadow:none;border:1px solid var(--color-v3-outline-var)}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]   mat-expansion-panel-header[_ngcontent-%COMP%]{padding-left:16px;padding-right:8px}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]   mat-expansion-panel-header-title[_ngcontent-%COMP%]{min-width:0}@media screen and (max-width:600px){[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]{--mat-expansion-header-collapsed-state-height:36px;--mat-expansion-header-expanded-state-height:36px}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]   mat-expansion-panel-header[_ngcontent-%COMP%]{padding-left:8px}}.projects-list-header[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;gap:4px;overflow:hidden}.project-names-inline[_ngcontent-%COMP%]{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:14px;font-weight:400;line-height:21px}.project-names-inline[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{color:var(--color-v3-text-link);text-decoration:none}.project-names-inline[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{text-decoration:underline}.title[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:14px;font-weight:500;line-height:21px;overflow:hidden;padding:0;color:var(--color-v3-text)}.content[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:16px;margin-top:8px;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;gap:12px}.content[_ngcontent-%COMP%]   .projects-list[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;gap:8px}.content[_ngcontent-%COMP%]   .projects-link[_ngcontent-%COMP%]{width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}.subheader[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;gap:8px}.import-button[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:18px;color:var(--color-v3-text-on-button)}.imported-info[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:18px}.imported-label[_ngcontent-%COMP%]{color:var(--color-v3-text)}.imported-count[_ngcontent-%COMP%]{color:var(--color-v3-text-var)}.projects-info[_ngcontent-%COMP%]{border:1px solid var(--color-v3-outline-var);background-color:var(--color-v3-surface-container);border-radius:12px;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;gap:8px;min-width:0;height:55px;padding:16px}@media screen and (max-width:600px){.projects-info[_ngcontent-%COMP%]{height:38px;padding:8px}}.projects-info.expanded[_ngcontent-%COMP%]{-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:start;-webkit-align-items:flex-start;-moz-box-align:start;-ms-flex-align:start;align-items:flex-start;height:auto}.projects-info.expanded[_ngcontent-%COMP%]   .toggle-button-container[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-moz-box-pack:center;-ms-flex-pack:center;justify-content:center;width:100%}.projects-list[_ngcontent-%COMP%]{-webkit-box-flex:1;-webkit-flex:1;-moz-box-flex:1;-ms-flex:1;flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.projects-list.expanded[_ngcontent-%COMP%]{white-space:normal;overflow:visible;text-overflow:unset}.projects-count[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:14px;font-weight:500;line-height:21px;color:var(--color-v3-text)}.project-name[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:14px;font-weight:400;line-height:21px}.toggle-button[_ngcontent-%COMP%]{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0}"]
		});
		var DNd = class {
			constructor() {
				this.Ul = _.OG;
				...
				this.subtitle = _.V("");
				this.U$a = _.V(true);
				this.Beb = _.V("BILLING_ACCOUNT_SET_UP");
				this.nVa = _.V(0);
				this.vo = _.V("");
				this.SDa = _.V("");
				this.buttonText = _.W(() => {
					switch (this.Beb()) {
						case "PREPAY_PAYMENT_SETUP": return "Set up prepay";
						default: return "Set up billing";
					}
				});
				this.fC = () => {
					this.A.fC(this.vo());
		...
		DNd.ka = _.u({
			type: DNd,
			da: [["ms-billing-zero-state"]],
			inputs: {
				title: [1, "title"],
				subtitle: [1, "subtitle"],
				U$a: [1, "showSetupBillingButton"],
				Beb: [1, "zeroStateType"],
				nVa: [1, "buttonVe"],
				vo: [1, "billingAccountName"],
				SDa: [1, "learnMoreDocumentPath"]
			},
			fc: ["[actions]"],
			ha: 11,
			ia: 4,
			la: () => [
				" Learn more ",
				[1, "zero-state-content"],
				[1, "zero-state-text"],
				[1, "zero-state-title"],
				[1, "zero-state-subtitle"],
				[
					"data-test-id",
					"learn-more-link",
					3,
			...
			template: function(a, b) {
				if (a & 1) {
					_.Xh(BNd), _.F(0, "div", 1), _.I(1, "ms-sparkle-icon"), _.F(2, "div", 2)(3, "div", 3), _.R(4), _.H(), _.F(5, "div", 4), _.R(6), _.B(7, SMd, 2, 4, "a", 5), _.H()(), _.F(8, "div", 6), _.B(9, TMd, 2, 6, "button", 7), _.Yh(10), _.H()();
				}
				if (a & 2) {
					_.y(4), _.S(" ", b.title(), " "), _.y(2), _.S(" ", b.subtitle(), " "), _.y(), _.C(b.SDa() ? 7 : -1), _.y(2), _.C(b.U$a() ? 9 : -1);
				}
			},
			dependencies: [
				_.Yy,
			...
			styles: ["ms-sparkle-icon[_ngcontent-%COMP%]{height:135px;width:135px}.zero-state-text[_ngcontent-%COMP%]{-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;gap:8px}.zero-state-title[_ngcontent-%COMP%]{color:var(--color-v3-text);font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:14px;font-weight:500;line-height:21px}.zero-state-subtitle[_ngcontent-%COMP%]{color:var(--color-v3-text-var);text-align:center;max-width:450px;font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:18px}.zero-state-content[_ngcontent-%COMP%]{max-width:600px;margin:0 auto;padding:32px 0;text-align:center;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column;gap:8px}.zero-state-actions[_ngcontent-%COMP%]{margin-top:24px}"]
		});
		var ENd = class {
			constructor() {
				this.Ul = _.OG;
				...
				this.ve = { aOa: 311857 };
				this.U = _.m(_.Qu);
				this.Hb = _.Nn(this.U.Oe);
				this.locale = _.m(_.Si);
				this.R = new _.sz(this.locale);
				this.I = _.m(_.y6);
				this.T6 = _.Ni(_.KE);
				this.H = _.m(_.GG);
				this.Vmb = "Unable to load billing account tier cap";
				this.cnb = "No billing account tier cap";
				this.F = _.W(() => [
					{
						MF: 20,
						title: "Free",
						criteria: ["Set up and link an active billing account"],
						hva: this.A() ? "Set up billing" : undefined,
						gva: this.A() ? () => {
							this.I.fC(this.vo());
						} : undefined
					},
					{
						MF: 30,
						title: "Paid 1",
						criteria: ["At least $100 USD spent on Gemini API since account creation.", "At least 3 days passed since first successful payment."]
					},
					{
						MF: 40,
						title: "Paid 2",
						criteria: ["At least $1,000 USD spent on Gemini API since account creation.", "At least 30 days passed since first successful payment."]
					},
					{
						MF: 50,
						title: "Paid 3",
						...
						Vvb: "open_in_new",
						gva: () => {
							_.rd(window, _.jd("https://forms.gle/EVjVjL1f9HhSrPse9"), "_blank");
						}
					},
					{
						MF: 0,
						title: "Unavailable Tier",
						criteria: []
					},
					{
						MF: 1,
				...
				this.Lu = _.W(() => {
					var a;
					return (a = this.F().find((b) => b.MF === this.Iy())) != null ? a : this.F()[0];
				});
				this.Yzb = _.W(() => {
					var a = this.Lu().criteria.length;
					return new _.xd("{COUNT, plural, =1 {Once the following criterion is met, you'll automatically move to the next tier:}other {Once the following criteria are met, you'll automatically move to the next tier:}}").format({ COUNT: a });
				});
				this.A = _.W(() => xNd(this.H, this.vo()));
				this.HHa = _.W(() => {
					switch (this.Iy()) {
						case 20: return "title badge free-tier";
						case 30: return "title badge paid-tier-1";
						case 40: return "title badge paid-tier-2";
						case 50: return "title badge paid-tier-3";
						case 0:
						case 1: return "title badge unavailable-tier";
						default: return "";
					}
				});
				this.iyb = _.W(() => this.eZ() || this.Iy() === 20 || this.Iy() === 0 || this.Iy() === 1);
				this.MDb = _.W(() => {
					var a = this.gZa();
					if (!a) return "";
					var b = "";
					var c = Number.isInteger(a.amount);
					{
						let d;
						b = (d = this.R.transform(a.amount, a.S5, "symbol", c ? "1.0-0" : undefined)) != null ? d : "";
					}
					if (!b) {
						b = c ? `${a.S5} ${a.amount}` : `${a.S5} ${a.amount.toFixed(2)}`;
					}
					return b;
				});
				_.Fk([this.vo], () => {
		...
		ENd.ka = _.u({
			...
			inputs: {
				...
				vo: [1, "billingAccountName"],
				gZa: [1, "effectiveCap"],
				eZ: [1, "hasUnlimitedCap"]
			},
			ha: 16,
			ia: 10,
			la: () => [
				" · �0� Billing Account Tier Cap ",
				"For custom tiers with higher limits, please submit a request. Learn more in �#2� billing and tiers documentation�/#2�.",
				" Billing account restricted. API access may be disabled. ",
				" Unable to fetch your tier. Try again later. ",
				"Billing for the Gemini API is based on your payment history.",
				" Visit our �#2� usage tiers documentation�/#2� to learn more about the limits associated with each tier. ",
				[1, "custom-expand-icon"],
				[1, "title-variant"],
				[1, "content"],
				[
				...
				[
					"documentation-path",
					"/gemini-api/docs/billing#about-billing",
					3,
					"ve",
					"veClick",
					"veImpression"
			...
			template: function(a, b) {
				if (a & 1) {
					_.F(0, "mat-expansion-panel")(1, "mat-expansion-panel-header", 6)(2, "mat-panel-title"), _.R(3), _.Th(4), _.B(5, XMd, 4, 1, "span", 7), _.H()(), _.F(6, "div", 8)(7, "p"), _.Th(8), _.B(9, YMd, 3, 3, "span")(10, ZMd, 2, 0, "span")(11, $Md, 2, 0, "span")(12, cNd, 2, 2), _.H(), _.B(13, eNd, 3, 0, "ul"), _.B(14, fNd, 2, 4, "button", 9), _.B(15, gNd, 3, 3, "p"), _.H()();
				}
				if (a & 2) {
					_.y(2);
					_.qi(b.HHa());
					...
					a = _.Uh(b.Lu().MF);
					_.y();
					_.C(a === b.jA.ROa ? 9 : a === b.jA.TOa ? 10 : a === b.jA.SOa ? 11 : 12);
					_.y(4);
					_.C(b.Lu().criteria.length > 0 ? 13 : -1);
					_.y();
					_.C(b.Lu().gva && b.Lu().hva ? 14 : -1);
					_.y();
					_.C(b.Lu().MF !== b.jA.ROa && b.Lu().MF !== b.jA.TOa && b.Lu().MF !== b.jA.SOa ? 15 : -1);
				}
			},
			dependencies: [
				_.Yy,
			...
			styles: ["[_nghost-%COMP%]{min-width:0}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]{--mat-expansion-header-collapsed-state-height:53px;--mat-expansion-header-expanded-state-height:53px;--mat-expansion-container-shape:12px;background-color:var(--color-v3-surface-container);box-shadow:none;border:1px solid var(--color-v3-outline-var)}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]   mat-expansion-panel-header[_ngcontent-%COMP%]{padding-left:16px;padding-right:8px}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]   mat-expansion-panel-header-title[_ngcontent-%COMP%]{min-width:0}@media screen and (max-width:600px){[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]{--mat-expansion-header-collapsed-state-height:36px;--mat-expansion-header-expanded-state-height:36px}[_nghost-%COMP%]   mat-expansion-panel[_ngcontent-%COMP%]   mat-expansion-panel-header[_ngcontent-%COMP%]{padding-left:8px}}.badge[_ngcontent-%COMP%]{border-radius:8px;padding:1px 6px 1px 5px;border:1px solid var(--color-v3-outline);background-color:var(--color-v3-surface-container-high);color:var(--color-v3-text);display:-webkit-inline-box;display:-webkit-inline-flex;display:-moz-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;gap:5px;font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:16px;border:none;background:transparent;color:var(--color-v3-text-on-button);white-space:nowrap}.badge[_ngcontent-%COMP%]:before{content:\"\";width:6px;aspect-ratio:1/1;border-radius:50%;-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0}.badge.enabled[_ngcontent-%COMP%]:before, .badge.green[_ngcontent-%COMP%]:before, .badge.new[_ngcontent-%COMP%]:before{background-color:var(--color-v3-accent-4)}.badge.gray[_ngcontent-%COMP%]:before, .badge.not-enabled[_ngcontent-%COMP%]:before{background-color:var(--color-v3-text-var)}.badge.confidential[_ngcontent-%COMP%]:before, .badge.orange[_ngcontent-%COMP%]:before{background-color:var(--color-v3-accent-1)}.badge.blue[_ngcontent-%COMP%]:before, .badge.paid[_ngcontent-%COMP%]:before{background-color:var(--color-v3-text-link)}.badge.alert[_ngcontent-%COMP%]:before, .badge.red[_ngcontent-%COMP%]:before{background-color:var(--color-v3-accent-3)}.badge.hide-circle[_ngcontent-%COMP%]:before{display:none}.badge.free-tier[_ngcontent-%COMP%]:before{background-color:var(--color-v3-text-on-button)}.badge.paid-tier-1[_ngcontent-%COMP%]:before{background-color:var(--color-v3-text-link)}.badge.paid-tier-2[_ngcontent-%COMP%]:before{background-color:var(--color-v3-accent-2)}.badge.paid-tier-3[_ngcontent-%COMP%]:before{background-color:var(--color-v3-accent-4)}.badge.unavailable-tier[_ngcontent-%COMP%]:before{background-color:var(--color-v3-text-disable)}.badge-after.new[_ngcontent-%COMP%]:before, .badge-after[_ngcontent-%COMP%]:before{content:normal;width:auto;aspect-ratio:auto;border-radius:unset;background-color:unset}.badge-after[_ngcontent-%COMP%]:after{content:\"\";width:6px;aspect-ratio:1/1;border-radius:50%}.badge-after.new[_ngcontent-%COMP%]:after{background-color:var(--color-v3-accent-4)}.title[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:14px;font-weight:500;line-height:21px;overflow:hidden;padding:0;margin-right:4px}.title-variant[_ngcontent-%COMP%]{color:var(--color-v3-text-var);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.content[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:16px;margin-top:8px}"]
		});
		var FNd = function(a) {
			_.x(function* () {
				a: {
					...
					for (let c = 0; c < b.length; c++) {
						let d = b[c];
						let e = _.Kjd() ? "https://billing-ads-qa-devel.corp.google.com/payments/v4/js/integrator.js?ss=md" : "https://payments.google.com/payments/v4/js/integrator.js?ss=md";
						if (d.src === e) {
							b = true;
							break a;
						}
				...
				if (b) a.H.set(true);
					...
					yield _.iDa(_.Kjd() ? (0, _.Kj)`https://billing-ads-qa-devel.corp.google.com/payments/v4/js/integrator.js?ss=md` : (0, _.Kj)`https://payments.google.com/payments/v4/js/integrator.js?ss=md`, { attributes: { "data-payments-main": "" } });
					a.H.set(true);
				} catch (c) {
					a.H.set(false);
					a.woa.set(c);
		...
		var GNd = function(a, b, c) {
			return new _.ef((d) => {
				if (payments) if (b) {
					if (a.F) try {
						a.F.unload();
					} catch (f) {
						a.A.warning(Error("Ei", { cause: f }));
					} finally {
						a.F = null;
					}
					try {
						var e = payments.business.integration.Style;
						let f = payments.business.integration.mashupMode.embedded("payments-widget-container").usingWindowConstrainedPopup();
						let g = payments.business.integration.bootstrap.asMashupMode(f);
						g.usingUserIndex(a.U.A).usingLocale("en").usingDefaultActivityStatusChangeHandler().usingStyle(e.create().withMaterial2Style().withPlainTextNavigation());
						let k = g.forWidget().embeddedLandingPage();
						k.withEncryptedParameters(b).withIntegratorCallback(c).load();
						a.F = k;
					} catch (f) {
						_.Mw(a.A, Error("Fi", { cause: f }));
						d.error(f);
					}
				} else {
					e = Error("Gi");
		...
		var z6 = class {
			constructor() {
				...
				this.I = _.M(false);
				this.M6 = _.M(false);
				this.fa = this.H.asReadonly();
				this.ea = this.woa.asReadonly();
				this.R = this.I.asReadonly();
				this.aa = this.M6.asReadonly();
			}
		};
		z6.J = function(a) {
			return new (a || z6)();
		...
		var JNd = class {
			constructor() {
				...
				this.vo = _.W(() => {
					var a;
					var b;
					return (b = (a = this.billingAccount()) == null ? undefined : a.getName()) != null ? b : "";
				});
				this.I = _.W(() => {
					var a;
					var b;
					return (b = (a = this.billingAccount()) == null ? undefined : a.RY()) != null ? b : 0;
				});
				this.M6 = this.A.aa;
				this.wHb = this.A.R;
				this.F = _.M("");
				this.xna = _.Ni.required("paymentsWidgetContainer");
				_.Fk([this.vo, this.I], () => {
					var a = this;
					return _.x(function* () {
						var b = a.vo();
						if (b) {
							a.F.set("");
							var c;
							let d = (c = a.xna()) == null ? undefined : c.nativeElement;
				...
				_.Fk([
					...
					return _.x(function* () {
						if (a.H() && a.xna() && a.F()) {
							yield _.pf(GNd(a.A, a.F(), (b) => {
								if (b === "ON_BILLING_DATA_CHANGE") {
									a.l7a.emit();
								}
							}));
						}
		...
		JNd.ka = _.u({
			...
			inputs: { billingAccount: [1, "billingAccount"] },
			outputs: { l7a: "paymentDataChange" },
			ha: 5,
			ia: 2,
			la: () => [
				["paymentsWidgetContainer", ""],
				[1, "non-embedded-container"],
				["mode", "indeterminate"],
				[
					"data-test-id",
					"payments-script-error",
					"calloutType",
					"error",
					"contentText",
			...
			template: function(a, b) {
				if (a & 1) {
					_.F(0, "div", 1), _.B(1, hNd, 1, 0, "mat-progress-bar", 2), _.B(2, iNd, 1, 1, "ms-callout", 3), _.H(), _.I(3, "div", 4, 0);
				}
				if (a & 2) {
					_.y(), _.C(b.wHb() ? 1 : -1), _.y(), _.C(b.M6() || b.woa() ? 2 : -1);
				}
			},
			dependencies: [_.zA, _.sO],
			styles: [".dark-theme[_nghost-%COMP%]   .payments-widget-container[_ngcontent-%COMP%], .dark-theme   [_nghost-%COMP%]   .payments-widget-container[_ngcontent-%COMP%]{-webkit-filter:invert(.906) hue-rotate(180deg);filter:invert(.906) hue-rotate(180deg)}.non-embedded-container[_ngcontent-%COMP%]{--mat-progress-bar-active-indicator-height:2px;--mat-progress-bar-track-height:2px}.non-embedded-container[_ngcontent-%COMP%]   mat-progress-bar[_ngcontent-%COMP%]{max-width:1032px}.non-embedded-container[_ngcontent-%COMP%] > *[_ngcontent-%COMP%]{margin:24px 24px}@media screen and (max-width:600px){.non-embedded-container[_ngcontent-%COMP%] > *[_ngcontent-%COMP%]{margin:24px auto}}"]
		});
		var KNd = class {
			constructor() {
				this.ve = { Uhb: 311859 };
				...
				return _.x(function* () {
					...
					try {
						...
						_.mm(a.A, _.nm, {
							...
							data: {
								content: "Successfully switched to postpay",
								Ne: "success",
								Aj: 20
							}
						});
						...
						_.mm(a.A, _.nm, {
							Rc: "ms-toast-snack-bar-container",
							data: {
								content: "Error switching to postpay",
								Ne: "error",
								Aj: 20
							}
						});
		...
		KNd.ka = _.u({
			type: KNd,
			da: [["ms-upgrade-dialog"]],
			ha: 11,
			ia: 6,
			la: () => [
				"Switch to postpay\n",
				" If you continue, your remaining credits will be refunded. This action cannot be undone. ",
				" Cancel ",
				"�*10:1��#1:1��/#1:1��/*10:1� Confirm ",
				[
					"mat-dialog-title",
					"",
					1,
			...
			template: function(a, b) {
				if (a & 1) {
					_.F(0, "h2", 4), _.Mh(1, 0), _.H(), _.F(2, "mat-dialog-content")(3, "span"), _.Mh(4, 1), _.H()(), _.F(5, "mat-dialog-actions", 5)(6, "button", 6), _.Mh(7, 2), _.H(), _.F(8, "button", 7), _.J("click", function() {
						return b.Pqa();
					}), _.Kh(9, 3), _.B(10, jNd, 2, 0, "mat-spinner", 8), _.Lh(), _.H()();
				}
				if (a & 2) {
					_.y(6), _.E("disabled", b.y9()), _.y(2), _.E("disabled", b.y9())("ve", b.ve.Uhb)("veClick", true)("veImpression", true), _.y(2), _.C(b.y9() ? 10 : -1);
				}
			},
			dependencies: [
				_.Yy,
			...
			styles: [".header[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;-moz-box-orient:horizontal;-moz-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:justify;-webkit-justify-content:space-between;-moz-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;padding:16px}.title[_ngcontent-%COMP%]{font-family:Inter Tight,sans-serif;font-optical-sizing:auto;font-size:16px;font-weight:600;line-height:24px;padding:0}mat-dialog-content[_ngcontent-%COMP%]{padding-left:20px;padding-bottom:0}"]
		});
		_.ks = class {
			constructor() {
				this.UC = _.m(_.GG);
				...
				this.dCb = this.I.getFlag(_.XFb);
				this.oa = this.I.getFlag(_.ZFb);
				this.na = this.I.getFlag(_.WFb);
				this.cCa = _.M(true);
				_.W(() => {
					var a = this.Hx();
					return a ? xMd(this.Za.Sd(), a) : [];
				...
				this.wra = _.W(() => {
					switch (this.Sg()) {
						case "NONE": return "No billing account";
						case "NO_PERMISSION": return "You do not have permission to view billing accounts";
						default: return "Something went wrong";
					}
				});
				this.BV = _.W(() => {
					switch (this.Sg()) {
						case "NONE": return "Set up billing and make prepayment to access higher rate limits, advanced features, exclusive models, and more.";
						case "NO_PERMISSION": return "Contact your billing account administrator to gain permission.";
						default: return "We could not load billing information. Please try again later.";
					}
				});
				this.dRb = _.W(() => !!this.Rp() && this.w3a() && !this.F());
				this.Rp = this.UC.Aa;
				this.U = this.UC.F;
				this.R = this.UC.za;
				this.F = _.W(() => this.UC.ea().has(this.Hx()));
				this.Hx = _.W(() => {
					var a;
					var b;
					return (b = (a = this.Rp()) == null ? undefined : a.getName()) != null ? b : "";
				});
				this.lba = _.W(() => {
					var a = this.Hx();
					return _.Pn(a);
				});
				this.J0 = _.W(() => !this.ma.A.small());
				this.Exb = _.W(() => this.U().map((a) => vNd(a)));
				this.ROb = _.W(() => {
					var a = this.Rp();
					return a ? [vNd(a)] : [];
				});
				this.jQb = _.W(() => {
					if (this.ea.R()) return false;
					var a;
					var b;
					return (b = this.F() && ((a = this.UC.A().get(this.Hx())) == null ? undefined : a.has("POSTPAY_PAYMENT_ACTION_NEEDED"))) != null ? b : false;
				});
				this.za = _.W(() => {
					var a;
					var b;
					return (b = (a = this.Rp()) == null ? undefined : _.Pm(a, 8)) != null ? b : false;
				});
				this.ta = _.W(() => xNd(this.UC, this.Hx()));
				this.w3a = _.W(() => this.za() && this.ta());
				this.BIb = _.W(() => {
					var a = this.Rp();
					return !!a && !this.F() && _.Lm(a, 12) === 2;
				});
				this.bJa = _.W(() => {
					var a = this.Rp();
					var b;
					return !!a && ((b = a.Ap()) == null ? undefined : b.includes(2));
				});
				this.HMb = _.W(() => this.bJa() ? "Prepay is required for this billing account." : "Contact your billing account administrator to get permission to set up prepay payment for this billing account.");
				this.H = _.W(() => !this.na && this.F() && this.R() === 3);
				this.Aa = _.W(() => !this.F() && this.R() === 3 && this.oa);
				this.A = _.M(false);
				this.Iyb = _.W(() => {
					if ((this.Aa() || this.H()) && this.Rp()) return {
						text: this.H() ? "Switch to postpay" : "Switch to prepay",
						click: () => {
							if (this.H()) {
								MNd(this);
							} else {
						...
						icon: this.H() ? "credit_card" : "paid",
						t1: "upgrade-button",
						ve: 312761,
						disabled: this.A() || !this.bJa()
					};
				});
				this.UBb = _.W(() => {
					var a = this.Rp();
				...
				this.eZ = _.W(() => {
					var a;
					var b;
					return (b = (a = this.Rp()) == null ? undefined : _.Pm(a, 14)) != null ? b : false;
				});
				this.TE = {
					text: "Docs",
					click: () => {
					...
					tooltip: "Documentation for Gemini API billing",
					ve: this.ve.Qhb
				};
				_.Fk([this.Hx], () => {
					var a = this;
			...
			ib() {
				...
				return _.x(function* () {
					...
					try {
						...
						if (_.pn(b)) {
							a.Sg.set("NO_PERMISSION");
						} else {
							a.Sg.set("GENERAL_ERROR");
						}
					} finally {
						a.cCa.set(false);
					}
			...
			Dxa() {
				var a = this.aa.copy(this.lba());
				this.fa.show({
					Ne: a ? "success" : "error",
					content: a ? "Copied to clipboard" : "Error copying to clipboard",
					Aj: a ? 8 : 20
				});
			}
			cF() {
				_.rd(this.window, _.jd("https://ai.google.dev/gemini-api/docs/billing"), "_blank");
			}
		};
		_.ks.J = function(a) {
			return new (a || _.ks)();
		...
		_.ks.ka = _.u({
			...
			ia: 5,
			la: () => [
				"Another payment profile has an issue.",
				" Visit Cloud Console to diagnose ",
				" ID: ",
				" Balance is for both Gemini API service and Cloud services. ",
				" Visit Cloud Console to diagnose ",
				" This graph shows Gemini API spend across both �#3�prepay and postpay�/#3� for your billing account. ",
				[1, "page-content-wrapper"],
				[1, "page-content-inner-wrapper"],
				[1, "page-contains-payment-widget-wrapper"],
				[
					"headerText",
					"Gemini API Billing",
					3,
				...
				[1, "has-selected-billing-account"],
				[
					"data-test-id",
					"billing-zero-state",
					3,
				...
				[1, "billing-account-selector-container"],
				[
					"labelText",
					"Billing account",
					1,
				...
				[
					...
					"borderless",
					1,
					"copy-billing-account-id-button",
					3,
					"click"
				],
				[1, "copy-billing-account-id-button-text"],
				[
					1,
					"copy-billing-account-id-button-icon",
					3,
					"iconName"
				],
				[1, "tier-and-projects"],
				...
				[
					...
					"prepay-zero-state",
					"title",
					"No prepayment method set up for this billing account",
					3,
					"zeroStateType",
					"subtitle",
					"showSetupBillingButton",
				...
				[
					"data-test-id",
					"inactive-or-no-payment-zero-state",
					"title",
					"The billing account type is inactive or unsupported.",
					3,
					"showSetupBillingButton",
					"zeroStateType",
					"learnMoreDocumentPath"
				],
				[
					3,
					"billingAccountId",
				...
				[1, "postpay-gemini-usage-callout"],
				[
					3,
					"paymentDataChange",
					"billingAccount"
				...
				[
					"href",
					"https://ai.google.dev/gemini-api/docs/billing#billing-plans",
					"target",
					"_blank"
				]
			],
			template: function(a, b) {
				if (a & 1) {
					_.F(0, "div", 6)(1, "div", 7)(2, "div", 8), _.I(3, "ms-dashboard-header", 9), _.B(4, lNd, 6, 3, "ms-callout", 10), _.B(5, mNd, 1, 0, "mat-spinner", 11)(6, tNd, 16, 14, "div", 12)(7, uNd, 1, 5, "ms-billing-zero-state", 13), _.H()()();
				}
				if (a & 2) {
					_.y(3), _.E("primaryButton", b.Iyb())("learnMoreButton", b.TE)("showQuotaTierBadge", false), _.y(), _.C(b.jQb() ? 4 : -1), _.y(), _.C(b.cCa() ? 5 : b.Rp() ? 6 : 7);
				}
			},
			dependencies: [
				ANd,
			...
			styles: [".billing-account-selector[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;gap:8px}.billing-account-selector[_ngcontent-%COMP%] > label[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:18px;-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;color:var(--color-v3-text-var)}.loading-spinner[_ngcontent-%COMP%]{display:block;margin:4px auto;background-color:var(--color-v3-surface-container);width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}.sdui-viewer-container[_ngcontent-%COMP%]{background-color:var(--color-v3-surface-container);border:1px solid var(--color-v3-outline-var);border-radius:12px;box-shadow:var(--v3-shadow-xs);padding:16px}[_nghost-%COMP%]{display:block;--chart-axis-label-light:#5d5d5f;--chart-grid-light:#eeeeec;--chart-axis-label-dark:#8c8c8c;--chart-grid-dark:#2a2a2a}[_nghost-%COMP%]   .page-content-inner-wrapper[_ngcontent-%COMP%]{max-width:min(1400px,90%)}@media screen and (max-width:600px){[_nghost-%COMP%]   .page-content-inner-wrapper[_ngcontent-%COMP%]{max-width:100%}}.page-contains-payment-widget-wrapper[_ngcontent-%COMP%]{max-width:1080px;padding:0 48px 0 0}@media screen and (max-width:600px){.page-contains-payment-widget-wrapper[_ngcontent-%COMP%]{padding:0}}.has-selected-billing-account[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.has-selected-billing-account[_ngcontent-%COMP%] > [_ngcontent-%COMP%]:not(.billing-account-selector-container):not(ms-payments){margin-top:24px}.has-selected-billing-account[_ngcontent-%COMP%]   ms-payments[_ngcontent-%COMP%]{margin-left:-24px;margin-right:-24px;margin-top:8px}@media screen and (max-width:600px){.has-selected-billing-account[_ngcontent-%COMP%]   ms-payments[_ngcontent-%COMP%]{margin-left:0;margin-right:0}}.has-selected-billing-account[_ngcontent-%COMP%]   ms-billing-sdui-chart[_ngcontent-%COMP%]{margin-top:0}@media screen and (max-width:600px){.has-selected-billing-account[_ngcontent-%COMP%] > span.postpay-gemini-usage-callout[_ngcontent-%COMP%]{margin-top:24px}}.billing-account-selector-container[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;gap:8px}@media screen and (max-width:600px){.billing-account-selector-container[_ngcontent-%COMP%]{-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-moz-box-orient:vertical;-moz-box-direction:normal;-ms-flex-direction:column;flex-direction:column}}.copy-billing-account-id-button[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-pack:start;-webkit-justify-content:flex-start;-moz-box-pack:start;-ms-flex-pack:start;justify-content:flex-start;padding:0 8px}.copy-billing-account-id-button-icon[_ngcontent-%COMP%]{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;font-size:16px}.copy-billing-account-id-button-text[_ngcontent-%COMP%]{font-family:Inter,sans-serif;font-optical-sizing:auto;font-size:12px;font-weight:400;line-height:18px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap}.billing-account-selector[_ngcontent-%COMP%]{max-width:400px;-webkit-box-flex:1;-webkit-flex-grow:1;-moz-box-flex:1;-ms-flex-positive:1;flex-grow:1}@media screen and (max-width:600px){.billing-account-selector[_ngcontent-%COMP%]{max-width:100%}}.callout[_ngcontent-%COMP%]{margin-bottom:20px}.callout-content[_ngcontent-%COMP%]{display:-webkit-box;display:-webkit-flex;display:-moz-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-webkit-align-items:center;-moz-box-align:center;-ms-flex-align:center;align-items:center;gap:8px;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap}.callout-action[_ngcontent-%COMP%]{display:block;max-width:180px;height:20px;padding:0}.tier-and-projects[_ngcontent-%COMP%]{display:grid;grid-template-columns:1fr 1fr;gap:24px}@media screen and (max-width:600px){.tier-and-projects[_ngcontent-%COMP%]{grid-template-columns:1fr;gap:8px}}.postpay-gemini-usage-callout[_ngcontent-%COMP%]{display:-webkit-inline-box;display:-webkit-inline-flex;display:-moz-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-align-self:flex-start;-ms-flex-item-align:start;align-self:flex-start;gap:8px}.postpay-gemini-usage-callout[_ngcontent-%COMP%] > span[_ngcontent-%COMP%]{line-height:20px}"]
		});
		_.ir();
	} catch (e) {
		_._DumpException(e);
