...
(function(_) {
	...
	try {
		...
		_.hr("CtkMdc");
		var due = [{
			image: "https://www.gstatic.com/aistudio/starter-apps/thumbnails/lyria_alarm_clock.png",
			video: "https://www.gstatic.com/aistudio/starter-apps/thumbnails/lyria_alarm_clock.mp4",
			title: "Lyria Alarm Clock",
			description: "An AI-powered alarm clock that composes a unique song every morning based on your agenda, weather, and location.",
			category: "featured",
			url: "/apps/bundled/lyria_alarm_clock",
			queryParams: {
				showPreview: "true",
				showAssistant: "true"
			}
		}, {
			image: "https://www.gstatic.com/aistudio/starter-apps/thumbnails/score_your_video_with_lyria.png",
			video: "https://www.gstatic.com/aistudio/starter-apps/thumbnails/score_your_video_with_lyria.mp4",
			title: "Score your video with Lyria",
			description: "Upload a video and generate a custom musical bed using Lyria.",
			category: "featured",
			url: "/apps/bundled/score_your_video_with_lyria",
			queryParams: {
				showPreview: "true",
				showAssistant: "true"
			}
		...
		_.Zr = class {
			constructor() {
				this.It = "video";
				this.Eq = "https://www.gstatic.com/aistudio-static/lyria/shape_wave_1.mp4";
				this.jZ = "Lyria";
				this.Jt = "High-fidelity music generation with Lyria 3 and Lyria RealTime";
				this.IFb = "centered";
				this.AB = [{
					text: "Get started",
					url: "https://aistudio.google.com/new_music",
					icon: "login"
				}, {
					text: "Docs",
				...
				this.blocks = [
					{
						...
						description: "Turn quick ideas or visual inspiration into cohesive, production-ready tracks. Generate anything from minimal techno beats to nuanced vocal performances.",
						Iu: "Try Lyria 3 Pro",
						Ju: "https://aistudio.google.com/new_music?model=lyria-3-pro-preview",
						ctaIcon: "login",
						image: "https://www.gstatic.com/aistudio-static/lyria/compose-music.jpg"
					},
					{
						Vk: "font",
						icon: "videocam_auto",
						title: "Compose music in real time",
						description: "Seamlessly transition between instruments, genres, and moods on the fly with Lyria RealTime.",
						Iu: "Try Lyria RealTime",
						Ju: "https://aistudio.google.com/new_music?model=lyria-realtime-exp",
						ctaIcon: "login",
						image: "https://www.gstatic.com/aistudio-static/lyria/steer-music.jpg"
					},
					{
						Vk: "font",
						icon: "screensaver_auto",
						title: "Granular control for audio generation",
						description: "Set the beats per minute (BPM), define the exact musical scale, and adjust tone for custom music apps.",
						Iu: "Try Lyria 3 Clip",
						Ju: "https://aistudio.google.com/new_music?model=lyria-3-clip-preview",
						ctaIcon: "login",
						image: "https://www.gstatic.com/aistudio-static/lyria/dial-in.jpg"
					}
				];
				this.pC = due;
				this.v5 = [{
		...
		_.Zr.ka = _.u({
			...
			template: function(a, b) {
				a & 1 && _.I(0, "ms-marketing-nav")(1, "ms-marketing-hero", 0)(2, "ms-marketing-blocks", 1)(3, "ms-marketing-remix", 2)(4, "ms-marketing-code-snippet", 3)(5, "ms-marketing-footer");
				a & 2 && (_.y(), _.E("mediaType", b.It)("mediaSrc", b.Eq)("title", b.jZ)("subtitle", b.Jt)("layout", b.IFb)("ctas", b.AB), _.y(), _.E("blocks", b.blocks), _.y(), _.E("cards", b.pC), _.y(), _.E("tabs", b.v5)("snippets", b.u5));
			},
			dependencies: [
				_.i8,
				_.u8,
